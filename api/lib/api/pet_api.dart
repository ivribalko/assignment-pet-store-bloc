...
class PetApi {
  ...
  Future<Response> addPet(
    ...
    return _dio.request(
      ...
      options: Options(
        ...
        extra: {
          'secure': [
            {"type": "oauth2", "name": "petstore_auth"}
          ],
        },
        contentType:
  ...
  Future<Response> deletePet(
    ...
    String _path =
        "/pet/{petId}".replaceAll("{" r'petId' "}", petId.toString());
  ...
  Future<Response<List<Pet>>> findPetsByStatus(
    ...
    return _dio
      ...
      BuiltList<Pet> dataList = _serializers.deserialize(
  ...
  Future<Response<Pet>> getPetById(
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<Pet>(serializer,
          response.data is String ? jsonDecode(response.data) : response.data);
  ...
  Future<Response<ApiResponse>> uploadFile(
    ...
    String _path = "/pet/{petId}/uploadImage"
    ...
    if (additionalMetadata != null) {
      formData[r'additionalMetadata'] =
          parameterToString(_serializers, additionalMetadata);
    }
    if (file != null) {
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<ApiResponse>(serializer,
          response.data is String ? jsonDecode(response.data) : response.data);
